    ...
    constructor() {
        this.templates = {
            'english-a1': {
                ...
                welcomeMessage: `
مرحباً بك في مركز اكاديمية نور للتدريب المتقدم! 🎉
...
فريق مركز اكاديمية نور للتدريب المتقدم
                `
            },
            'english-a2': {
...
مرحباً ${studentName} في مركز اكاديمية نور للتدريب المتقدم! 🎉

تم قبول طلب التسجيل الخاص بك بنجاح.

نحن سعداء لانضمامك إلى عائلة مركز اكاديمية نور للتدريب المتقدم ونتطلع لرحلة تعليمية مثمرة معك.
    ...
    sendWelcomeEmail(enrollment, welcomeData) {
        return new Promise((resolve, reject) => {
            ...
            setTimeout(() => {
                ...
                console.log('Subject: مرحباً بك في مركز اكاديمية نور للتدريب المتقدم');
